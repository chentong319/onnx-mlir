...
struct OnnxBuilder : DialectBuilder {
  ...
  mlir::Value gemm(mlir::Type Y, mlir::Value A, mlir::Value B, mlir::Value C, mlir::FloatAttr alpha, mlir::FloatAttr beta, mlir::IntegerAttr transA, mlir::IntegerAttr transB) const;
